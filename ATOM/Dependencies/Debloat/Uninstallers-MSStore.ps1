<#
	Uninstallers-MSStore.ps1 will uninstall metro apps based on the debloat mode setting (Safe, Balanced, Aggressive).
	For safety, the script will also check for the presence of user data (based on the existence of a specified folder),
	and will abort removing the app if detected.
#>
